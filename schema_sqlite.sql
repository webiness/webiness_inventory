...
CREATE TABLE IF NOT EXISTS document (
    ...
    d_type VARCHAR CHECK (d_type IN ('purchase', 'sale', 'dismission')) NOT NULL DEFAULT 'purchase',
    d_status VARCHAR CHECK (d_status IN ('draft', 'approved')) NOT NULL DEFAULT 'draft',
